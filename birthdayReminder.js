...
const data = [
  {
    ...
    date: "01/05/2001",
    image:
      "https://pixabay.com/photos/tree-sunset-clouds-sky-silhouette-736885/.jpg",
  },
  {
    id: 2,
    name: "Lyba Mansoori",
...
noOfBirthdays.innerHTML = todayData.length + " Birthday's Today";
...
function clearAll() {
  people.innerHTML = "";
  noOfBirthdays.innerHTML = "0 Birthday's Today";
}